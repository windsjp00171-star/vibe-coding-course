...
(function () {
  ...
  const COMMON = [
    ...
    { tour: 'print', title: '印出講義', text: '按這裡會打開這個單元的紙本講義：重點整理、名詞速查、練習和小測驗，約 2～4 張 A4，也可以存成 PDF。' },
    { tour: 'quizshow', title: '課堂搶答', text: '上課時投影出來玩：選單元、題目一題一題出、按空白鍵揭曉答案，右邊可以幫各組計分。不用登入也不用 PIN 碼。' },
    { tour: 'glossary', title: '名詞小辭典', text: '內文裡有虛線底線的字，點一下就會跳出白話解釋。想一次查全部，就按這裡。' },
  ];
